<%@ page language="java" contentType="text/html; charset=UTF-8"
    pageEncoding="UTF-8" import="java.util.*, gjavaweb.addrbook.*"%>
 
<% request.setCharacterEncoding("utf-8"); %>
<jsp:useBean id="dao" scope="application" class="gjavaweb.addrbook.AddrBookH2DAO"/>
...
<%
	...
	if(action.equals("list")) {
		ArrayList<AddrBook> datas = (ArrayList) dao.getDBList();
