...
<table border="1">
  <tr>
    <th>이 름</th>
    <td><input type="text" name="ab_name" value="${ab.ab_name}"></td>
  </tr>
  <tr>
    <th>email</th>
    <td><input type="text" name="ab_email" value="${ab.ab_email}"></td>
  </tr>
    <tr>
    <th>전화번호</th>
    <td><input type="text" name="ab_tel" value="${ab.ab_tel}"></td>
  </tr>
      <tr>
    <th>생 일</th>
    <td><input type="date" name="ab_birth" value="${ab.ab_birth}"></td>
  </tr>
  <tr>
    <th>회 사</th>
    <td><input type="text" name="ab_comdept" value="${ab.ab_comdept}"></td>
  </tr>
  <tr>
    <th>메 모</th>
    <td><input type="text" name="ab_memo" value="${ab.ab_memo}"></td>
  </tr>
  <tr>
